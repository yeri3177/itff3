...
<div class="container-fluid container-main">
	<button
		...
		data-bs-target="#subhead-container" aria-controls="subhead-container"
		aria-expanded="false" aria-label="Toolbar" style="">
		...
		<div class="row">
			<div class="col-md-12">
				<main>
					...
					<script src="components/com_gridbox/assets/js/ba-admin.js?2.12.6"
						type="text/javascript"></script>
					<script
						src="https://www.balbooa.com/demo-admin/components/com_gridbox/libraries/chart/chart.js"
						type="text/javascript"></script>
					<script type="text/javascript">
						...
						app.store = {
							...
							"confirmation" : {
								"name" : "",
								"email" : "",
								"subject" : "Thank You for Your Order at [Store Name]",
							...
							"completed" : {
								"name" : "",
								"email" : "",
								"subject" : "Your Order at [Store Name] Has Been Completed",
							...
							"currency" : {
								"symbol" : "\u20ac",
								"code" : "EUR",
								"position" : "right-currency-position",
								"thousand" : ",",
								"separator" : ".",
								"decimals" : "2"
							},
							...
							"checkout" : {
								...
								"registration" : true,
								"terms" : true,
								"terms_text" : "I have read and agree to the <a href=\"#\" target=\"_blank\">Terms and Conditions<\/a>",
								"minimum" : ""
							},
							"wishlist" : {
								"login" : false
							...
							"reminder" : {
								"name" : "",
								"email" : "",
								"subject" : "Your [Product Title] subscription expired on [Expiration Date]",
					...
					<script
						src="https://www.balbooa.com/demo-admin/components/com_gridbox/libraries/calendar/js/calendar.js"
						type="text/javascript"></script>
					<link rel="stylesheet"
						href="https://www.balbooa.com/demo-admin/components/com_gridbox/libraries/calendar/css/calendar.css">
					<div id="ba-notification">
						<i class="zmdi zmdi-close"></i>
						<h4>Error</h4>
						<p></p>
					</div>
					<div id="export-dialog" class="ba-modal-sm modal hide"
						style="display: none">
						...
						<div class="modal-body">
							<div>
								<ul>
									<li><label> Pages </label> <label
										class="ba-checkbox ba-hide-checkbox"> <input
											type="checkbox" checked="" disabled=""> <i
											class="zmdi zmdi-check"></i> <span></span>
									</label></li>
									<li><label> Theme </label> <label
										class="ba-checkbox ba-hide-checkbox"> <input
											type="checkbox" checked="" disabled=""> <i
											class="zmdi zmdi-check"></i> <span></span>
									</label></li>
									<li class="export-apps"><label> App </label> <label
										class="ba-checkbox ba-hide-checkbox"> <input
											type="checkbox" checked="" disabled=""> <i
											class="zmdi zmdi-check"></i> <span></span>
									</label></li>
									<li><label> Joomla! Menu </label> <label
										class="ba-checkbox ba-hide-checkbox"> <input
											type="checkbox" class="menu-export"> <i
											class="zmdi zmdi-check"></i> <span></span>
									</label></li>
								</ul>
							</div>
						...
						<div class="modal-footer">
							<a href="#" class="ba-btn" data-dismiss="modal">Cancel</a> <a
								href="#" class="ba-btn-primary apply-export">Save</a>
						</div>
					</div>
					<div id="uploader-modal"
						class="ba-modal-lg modal ba-modal-dialog hide"
						style="display: none" data-check="multiple">
						<div class="modal-body">
					...
					<form autocomplete="off"
						action="/demo-admin/administrator/index.php?option=com_gridbox"
						method="post" name="adminForm" id="adminForm">
						<div class="row-fluid">
							<div id="gridbox-container">
								<div id="gridbox-content">
									<script
										src="https://www.balbooa.com/demo-admin/components/com_gridbox/libraries/bootstrap/bootstrap.js"
										type="text/javascript"></script>
									<script type="text/javascript">
										var JUri = 'https://www.balbooa.com/demo-admin/', IMAGE_PATH = 'images';
										var gridboxLanguage = {
											"EDIT_NOT_PERMITTED" : "Edit not permitted.",
											"CREATE_NOT_PERMITTED" : "Create not permitted.",
											"SAVE_SUCCESS" : "Item saved.",
											"TITLE" : "Title",
											"SHORT_M1" : "Jan",
											"SHORT_M2" : "Feb",
											"SHORT_M3" : "Mar",
											...
											"SHORT_M11" : "Nov",
											"SHORT_M12" : "Dec",
											"2_4_BUSINESS_DAYS" : "2 - 4 business days",
											"ABOUT_GRIDBOX" : "About Gridbox",
											"ACTIVATE" : "Activate",
											...
											"ADD_EMAIL_AND_PRESS_ENTER" : "Add an email and press enter",
											"ADD_IMAGE" : "Add Image",
											"ADD_NEW_ITEM" : "Add New Item",
											"ADD_NEW_RANGE" : "Add New Range",
											"ADD_REGION" : "Add Region",
											"ADD_TAG" : "Add Tag",
											"ADD_TRACKING_INFO" : "Add Tracking Info",
											"ADJUST" : "Adjust",
											"ADMIN_EMAIL" : "Admin Email",
											"ADMIN_LABEL" : "Admin Label",
											"ADMIN_NOTIFICATION_NEW_ORDER" : "Admin Notification: New Order",
											"ADMIN_NOTIFICATION_OUT_OF_STOCK" : "Admin Notification: Out of Stock",
											"ADMINS" : "Admins",
											"ALIGNMENT" : "Alignment",
											...
											"APPROVED" : "Approved",
											"APPS" : "Apps",
											"ARE_YOU_SURE_DEACTIVATE" : "Are you sure you want to deactivate the license? The site will no longer receive updates.",
											"ASPECT_RATIO" : "Aspect Ratio",
											"ATTACHMENTS" : "Attachments",
											"ATTACHMENTS_TOOLTIP" : "Allows users to attach files and images to their posts.",
											"AUTHOR" : "Author",
											"AUTHORS" : "Authors",
											"AUTO_DELETING" : "Auto-Deleting",
											"AUTO_DELETING_TOOLTIP" : "Submissions with banned words, emails, IP addresses and links will be deleted automatically",
											"AVAILABLE" : "Available",
											"BACK" : "Back",
											"BAN_USER" : "Ban User",
											...
											"CATEGORY" : "Category",
											"CATEGORY_LIST_LAYOUT" : "Category List Layout",
											...
											"CLASS_SUFFIX_TOOLTIP" : "By adding a CSS suffix to the item, you can customize the style of the item by writing your own CSS.",
											"CLOSE" : "Close",
											"CODE" : "Code",
											...
											"COLUMN" : "Column",
											"COM_GRIDBOX" : "Gridbox",
											"COM_GRIDBOX_N_ITEMS_APPROVED" : "Item(s) was successfully approved",
											"COM_GRIDBOX_N_ITEMS_DELETED" : "Item(s) was successfully deleted",
											"COM_GRIDBOX_N_ITEMS_IMPORTED" : "Item(s) was successfully imported",
											...
											"COM_GRIDBOX_N_ITEMS_SPAMED" : "Item(s) was successfully moved to the spam",
											...
											"CONTRAST" : "Contrast",
											"COOKIES" : "Cookies",
											"COPY_TO_CLIPBOARD" : "\u0421opy to clipboard",
											"COUNT" : "Count",
											"COUNTRY" : "Country",
											...
											"CREATE_STORE_BACKUP_BEFORE_IMPORT" : "Create store backup before import",
											"CROP" : "Crop",
											"CURRENCY" : "Currency",
											"CURRENCY_SEPARATOR" : "Currency Separator",
											"CURRENCY_UNITS" : "Currency and Units",
											"CUSTOM" : "Custom",
											"CUSTOMER" : "Customer",
											"CUSTOMER_INFO" : "Customer Info",
											"CUSTOMER_LOGIN" : "Customer Login",
											"CUSTOMER_NOTIFICATION_ORDER_COMPLETED" : "Customer Notification: Order Completed",
											"CUSTOMER_NOTIFICATION_ORDER_CONFIRMATION" : "Customer Notification: Order Confirmation",
											"CUSTOMER_NOTIFICATION_SUBSCRIPTION_REMINDER" : "Customer Notification: Expiration and Renewal Reminder",
											"DAILY" : "Daily",
											"DASHBOARD" : "Dashboard",
											"DATA_TAGS" : "Data Tags",
											"DATE" : "Date",
											"DATE_LIMITATIONS" : "Date Limitations",
											"DAYS" : "Days",
											...
											"DELIVERY_COST_PER_WEIGHT_UNIT" : "Delivery cost per weight unit",
											"DELIVERY_COST_PRODUCT_UNIT" : "Delivery cost for one product unit",
											"DESCRIPTION" : "Description",
											"DIGITAL" : "Digital",
											"DISABLE_FOR_DISCOUNT" : "Disable for discount products",
											"DISCOUNT" : "Discount",
											"DISCOUNTS" : "Discounts",
											"DOT" : "Dot",
											"DOWNLOAD" : "Download",
											"DOWNLOAD_FILE" : "Download File",
											"DRAG_DROP_SORT_ITEMS" : "Sort Items by Drag and Drop",
											"DROPDOWN" : "Dropdown",
											"DUPLICATE" : "Duplicate",
											"EDIT" : "Edit",
											"EDIT_LAYOUTS" : "Edit Layouts",
											"EMAIL" : "Email",
											...
											"FEATURED" : "Featured",
											"FILE_SIZE" : "File Size",
											"FILTER_AND_EFFECTS" : "Filter and Effects",
											"FLAT_RATE" : "Flat Rate",
											...
											"GRAYSCALE" : "Grayscale",
											"GRIDBOX" : "Gridbox",
											"GRIDBOX_CSV_FILE" : "Gridbox CSV File",
											"GRIDBOX_DUPLICATED" : "Item(s) was successfully duplicated",
											"GRIDBOX_IS_UP_TO_DATE" : "Gridbox is up to date",
											...
											"IMPORT_JOOMLA_CONTENT" : "Import Joomla Content",
											...
											"INCLUDE_ITEM_TOOLTIP" : "Disable an option if you want to exclude an item from the sitemap",
											"INCLUDES" : "Includes",
											...
											"IP_TRACKING_TOOLTIP" : "Enable option to view user IP address",
											...
											"NONE_SELECTED" : "None",
											"NOT_ALLOWED_FILE_SIZE" : "The file(s) size exceeded the maximum upload size",
											"NOT_SUPPORTED_FILE" : "Not supported file format",
											"NOTIFICATIONS" : "Notifications",
											"NUMBER_OF_DECIMALS" : "Number of Decimals",
											"OFFER_FREE_SHIPPING_OVER_AMOUNT" : "Offer Free shipping over the amount",
											"ONLY_FOR_GUEST" : "Only For Guest",
											"ONLY_FOR_GUEST_TOOLTIP" : "Display reCAPTCHA only for non-registered users",
											"OPACITY" : "Opacity",
											"OPTIONS" : "Options",
											"ORDER" : "Order",
											...
											"ORIGINAL" : "Original",
											"OVERWRITE_PRODUCTS_WITH_SAME_ID" : "Overwrite products with the same ID",
											"PAGE" : "Page",
											...
											"PHOTOS" : "Photos",
											"PHOTOS_TOOLTIP" : "Allows users to attach photos to their posts.",
											"PHYSICAL" : "Physical",
											"POSITION" : "Position",
											"POUNDS" : "Pounds (lb)",
											"PRELIMINARY_IMPORT_CHECK" : "Preliminary Import Check",
											"PRELOADER" : "Preloader",
											"PREV" : "Prev",
											"PRICE" : "Price",
											"PRINT" : "Print",
											...
											"QTY" : "Qty",
											"RADIO" : "Radio",
											"RATE_BY_PRICE" : "Rate by Price",
											"RATE_BY_WEIGHT_RANGE" : "Rate by Weight Range",
											"RATE_BY_WEIGHT_UNIT" : "Rate per Weight Unit",
											"RATE_PER_CATEGORY" : "Rate per Category",
											"RATE_PER_PRODUCT" : "Rate per Product",
											"RATING" : "Rating",
											...
											"REPLY" : "Reply",
											"REQUIRED" : "Required",
											"REQUIRED_COLUMN_NOT_PRESENT" : "The required column not present",
											"RESET" : "Reset",
											...
											"SELECT" : "Select",
											"SELECT_APP_TO_IMPORT_ARTICLES" : "Select an app to import articles",
											...
											"SINGLE_POST_LAYOUT" : "Single Post Layout",
											"SITEMAP" : "Sitemap",
											"SKU" : "SKU",
											...
											"STORE_LEGAL_NAME" : "Store Legal Business Name",
											...
											"SUBJECT" : "Subject",
											"SUBMISSIONS_PREMODERATION" : "Submissions pre-moderation",
											"SUBMISSIONS_PREMODERATION_TOOLTIP" : "Moderators must approve a submission before it is publishing",
											"SUBSCRIPTION" : "Subscription",
											"SUBSCRIPTION_ALREADY_USE" : "This subscription is already in use or you have exceeded the maximum number of allowed activations.",
											...
											"SUCCESSFULLY_BANNED" : "The user has been successfully banned",
											"SUCCESSFULLY_COPIED_TO_CLIPBOARD" : "Successfully copied to clipboard",
											"SUCCESSFULY_DEACTIVATED" : "You have successfully deactivated a license for this domain",
											"SYMBOL" : "Symbol",
											...
											"TAX_MODE" : "Tax Mode",
											"TAX_ON_SHIPPING" : "Tax on Shipping",
											"TAX_RATE" : "Tax Rate",
											"TAXES_RATES" : "Taxes and Rates",
											...
											"USED" : "Used",
											"USER" : "User",
											"USER_CANNOT_BE_BANNED" : "User cannot be banned. Missing email and IP address.",
											"USER_GROUPS" : "User Groups",
											"USER_NOTIFICATIONS" : "User Notifications",
											"USER_NOTIFICATIONS_TOOLTIP" : "Users will receive email notifications when someone has reply to his submission",
											"USER_REGISTRATION_FORM" : "User Registration Form",
											"USERGROUP" : "User Group",
											"USERNAME" : "Username",
											"USERNAME_ALREADY_USE" : "This username is already in use",
											"VALUES" : "Values",
											"VIEW" : "View",
											...
											"WIDTH" : "Width",
											"WISHLIST" : "Wishlist",
											"WISHLIST_ONLY_AUTHENTICATED" : "Only for authenticated users",
											"WRITE_COMMENT_HERE" : "Write your comment here...",
											"YEAR" : "Year",
											"YEARLY" : "Yearly",
											"YEARS" : "Years",
											"YOUR_LICENSE_ACTIVE" : "Your license is active",
											"ZIP_CODE" : "Zip Code",
											"EXPIRATION_DATE" : "Expiration Date",
											"FROM_NAME" : "From Name",
											"FROM_EMAIL" : "From Email",
											"GROUP" : "Group",
											"DRAG_IT_OUT_UNGROUP" : "Drag it out to ungroup"
										};
									</script>
									<div class="ba-sidebar">
										<div>
											<span class="toggle-sidebar"> <a href="#"> <span
													class="zmdi zmdi-format-clear-all"></span>
											</a>
											</span>
										</div>
										<div>
											<span class="dashboard active"> <a
												href="index.php?option=com_gridbox"> <span
													class="zmdi zmdi-home"></span> <span class="sidebar-title">Dashboard</span>
											</a> <span class="ba-tooltip ba-right ba-hide-element">Dashboard</span>
											</span> <span class="app-list sidebar-context-parent "
												data-context="apps-list-context-menu"> <a
												href="index.php?option=com_gridbox&amp;view=appslist"> <span
													class="zmdi zmdi-widgets"></span> <span
													class="sidebar-title">Apps</span> <i
													class="zmdi zmdi-caret-right"></i>
											</a>
											</span> <span class="gridbox-themes "> <a
												href="index.php?option=com_gridbox&amp;view=themes"> <span
													class="zmdi zmdi-format-color-fill"></span> <span
													class="sidebar-title">Themes</span>
											</a> <span class="ba-tooltip ba-right ba-hide-element">Themes</span>
											</span>
											<div class="ba-system-actions">
												<span class="gridbox-store sidebar-context-parent "
													data-context="store-context-menu"> <a
													href="index.php?option=com_gridbox&amp;view=orders"> <span
														class="zmdi zmdi-shopping-cart"></span> <span
														class="sidebar-title">Store</span> <i
														class="zmdi zmdi-caret-right"></i>
												</a>
												</span> <span class="app "> <a
													href="index.php?option=com_gridbox&amp;view=comments">
														<span class="zmdi zmdi-comment-more"></span> <span
														class="sidebar-title">Comments</span>
												</a> <span class="ba-tooltip ba-right ba-hide-element">Comments</span>
												</span> <span class="app "> <a
													href="index.php?option=com_gridbox&amp;view=reviews"> <span
														class="zmdi zmdi-ticket-star"></span> <span
														class="sidebar-title">Reviews</span>
												</a> <span class="ba-tooltip ba-right ba-hide-element">Reviews</span>
												</span> <span class="authors-pages "> <a
													href="index.php?option=com_gridbox&amp;view=authors"> <span
														class="zmdi zmdi-account-circle"></span> <span
														class="sidebar-title">Authors</span>
												</a> <span class="ba-tooltip ba-right ba-hide-element">Authors</span>
												</span> <span class="app "> <a
													href="index.php?option=com_gridbox&amp;view=tags"> <span
														class="zmdi zmdi-label"></span> <span
														class="sidebar-title">Tags</span>
												</a> <span class="ba-tooltip ba-right ba-hide-element">Tags</span>
												</span>
											</div>
											<span class="system-pages "> <a
												href="index.php?option=com_gridbox&amp;view=system"> <span
													class="zmdi zmdi-alert-polygon"></span> <span
													class="sidebar-title">System Pages</span>
											</a> <span class="ba-tooltip ba-right ba-hide-element">System
													Pages</span>
											</span> <span class="trashed-items "> <a
												href="index.php?option=com_gridbox&amp;view=trashed"> <span
													class="zmdi zmdi-delete"></span> <span
													class="sidebar-title">Trashed Items</span>
											</a> <span class="ba-tooltip ba-right ba-hide-element">Trashed
													Items</span>
											</span> <span class="gridbox-options sidebar-context-parent"
												data-context="options-context-menu"> <a href="#">
													<span class="zmdi zmdi-settings"></span> <span
													class="sidebar-title">Options</span> <i
													class="zmdi zmdi-caret-right"></i>
											</a>
											</span>
										</div>
										...
										<div class="modal-body">
											<div class="ba-login-dialog">
												<div class="ba-header-content">
													<h3 class="ba-modal-header">Activate license</h3>
													<label class="ba-help-icon"> <i
														class="zmdi zmdi-help"></i> <span
														class="ba-tooltip ba-help ba-hide-element"> Enter
															your Balbooa username and password into the relevant
															fields </span>
													</label>
												</div>
												<div class="ba-body-content">
													<div class="ba-input-lg">
														<input class="ba-username reset-input-margin" type="text"
															autocomplete="off" placeholder="Username"> <span
															class="focus-underline"></span>
													</div>
													<div class="ba-input-lg">
														<input class="ba-password" type="password"
															name="ba-password" autocomplete="off"
												...
												<div class="ba-footer-content">
													<a href="#"
														class="ba-btn-primary login-button active-button">
														Activate </a>
												</div>
											</div>
										</div>
									...
									<div class="ba-context-menu apps-list-context-menu"
										...
										<span class="context-menu-item-link" data-id="0"> <a
											...
											class="default-action"> <i class="zmdi zmdi-hotel"></i> <span>
													Hotel Rooms </span>
										</a>
											...
											<div class="filter-dashboars-icons-wrapper">
												<span class="ba-dashboard-popover-trigger"
													...
													class="about-notifications-count" style="display: none;">
														...
														Gridbox</span>
												</span> <span class="gridbox-languages"> <i
													class="zmdi zmdi-globe"></i> <span
													class="ba-tooltip ba-top ba-hide-element">Languages</span>
												</span>
											</div>
										</div>
										<div class="main-table dashboard-content">
														...
														<div class="ba-store-statistic-header-filter-wrapper">
															<div class="ba-store-statistic-action-wrapper">
																<span class="ba-store-statistic-action" data-action="-">
																	<i class="zmdi zmdi-caret-left"></i> <span
															...
															<div class="ba-store-statistic-select-wrapper">
																<div class="ba-custom-select ba-store-statistic-select">
																	...
																	<input type="hidden" value="d"
																		data-current="2021-12-16">
																	<ul>
																		<li data-value="d" data-text="Dec 16, 2021">
																			Daily</li>
																		<li data-value="w"
																			data-text="Dec 09, 2021 - Dec 15, 2021">Weekly</li>
																		<li data-value="m" data-text="Monthly, 2021">
																			Monthly</li>
																		<li data-value="y" data-text="Yearly">Yearly</li>
																		<li data-value="c"
																			data-text="Dec 16, 2021 - Dec 16, 2021">Custom</li>
																	</ul>
															...
															<div class="span4">
																<div class="ba-store-statistic-total-price">
																	<span class="ba-store-statistic-title">Total</span> <span
																		class="ba-store-statistic-price">0.00 €</span>
																</div>
															</div>
														</div>
																...
																<div
																	...
																	<svg style="width: 764px; height: 420px;">
																		...
																		<text x="402" y="332" text-anchor="middle"
																			alignment-baseline="baseline">0.00 €</text></g></svg>
																</div>
															</div>
															...
															<tr>
																<td class="title-cell"><a target="_blank"
																	href="index.php?option=com_gridbox&amp;task=gridbox.edit&amp;id=43">
																		...
																		style="background-image: url(https://www.balbooa.com/demo-admin/images/products/51.jpg);"></span>
																		V-Neck Playsuit
																</a></td>
														...
														<tbody>
															<tr>
																<td><a
																	...
																	</span> <span class="recent-apps-title"> Pages </span>
																</a></td>
															</tr>
															<tr>
																<td><a
																	...
																	</span> <span class="recent-apps-title"> Blog </span>
																</a></td>
															</tr>
															<tr>
																<td><a
																	...
																	</span> <span class="recent-apps-title"> Zero App </span>
																</a></td>
															</tr>
															<tr>
																<td><a
																	href="index.php?option=com_gridbox&amp;view=apps&amp;id=15">
																		<span
																		class="post-intro-image gridbox-app-item-portfolio">
																			<i class="zmdi zmdi-camera"></i>
																	</span> <span class="recent-apps-title"> Portfolio </span>
																</a></td>
															</tr>
															<tr>
																<td><a
																	href="index.php?option=com_gridbox&amp;view=apps&amp;id=16">
																		<span
																		class="post-intro-image gridbox-app-item-hotel-rooms">
																			<i class="zmdi zmdi-hotel"></i>
																	</span> <span class="recent-apps-title"> Hotel Rooms </span>
																</a></td>
															</tr>
															<tr>
																<td><a
																	href="index.php?option=com_gridbox&amp;view=apps&amp;id=17">
																		<span
																		class="post-intro-image gridbox-app-item-products">
																			<i class="zmdi zmdi-shopping-basket"></i>
																	</span> <span class="recent-apps-title"> Products </span>
																</a></td>
															</tr>
														</tbody>
													</table>
											...
											<div class="row-fluid">
												<div class="span4 recent-gridbox-files">
													...
													<div class="gridbox-app-item-footer">
														<a href="#" class="dashboard-view-media-manager"> <i
															class="zmdi zmdi-folder"></i>
														</a>
													</div>
												</div>
															...
															<tr>
																<td class="name-cell"><span
																	class="comments-text-wrapper"> <span
																		...
																		</span> <span class="comments-message">My 32 year old
																				son rates this colour palette very alluring 😍</span>
																	</span>
																</span></td>
															</tr>
															<tr>
																	...
																	class="comments-text-wrapper"> <span
																		...
																		class="comments-text"> <span
																			class="comments-name-wrapper"> <span
																				...
																				class="comments-date">2019-05-30</span>
																		</span> <span class="comments-message">Elegant dude I
																				love the use of avatar and layout!</span>
																	</span>
																</span></td>
															</tr>
														</tbody>
																	...
																	class="comments-text-wrapper"> <span
																		...
																		class="comments-text"> <span
																			class="comments-name-wrapper"> <span
																				...
																				nothing I can say that hasn't been said already. It
																				is really an experience of a life time. Being so
																				close to nature in the open air is a wonderful
																				change from the hustle and bustle of the city. You
																				are also like a 10min walk to some restaurants and
																				grocery store. Would gladly stay here again. It's a
																				beautiful place to reconnect with yourself.</span>
																	</span>
																</span></td>
															</tr>
															<tr>
																<td class="name-cell"><span
																	class="comments-text-wrapper"> <span
																		...
																		class="comments-text"> <span
																			class="comments-name-wrapper"> <span
																				class="comments-name"> <span>Nicolle
																						Odom</span> <span class="review-rating-wrapper"> <i
																						class="zmdi zmdi-star active"></i> <i
																						class="zmdi zmdi-star active"></i> <i
																						class="zmdi zmdi-star active"></i> <i
																						class="zmdi zmdi-star active"></i> <i
																		...
																		</span> <span class="comments-message">We loved every
																				single moment of our time here, and didn’t want to
																				leave. We walked away with so much joy in our hearts
																				and a sense of calm we haven’t felt in a long time,
																				living in an especially hectic city. Most
																				importantly, perhaps, is the deep sense of gratitude
																				we felt, both for being able to experience this
																				exceptional place as well as for everything nature
																				makes possible. We are forever grateful, and will
																				forever remember your wise words about always having
																				an “escape” in life to rest and truly relax.</span>
																	</span>
																</span></td>
															</tr>
															<tr>
																<td class="name-cell"><span
																	class="comments-text-wrapper"> <span
																		...
																		</span> <span class="comments-message">Great location
																				and super clean, but noisy neighbors.</span>
																	</span>
																</span></td>
															</tr>
															<tr>
															...
															<tr>
																<td class="name-cell"><span
																	class="comments-text-wrapper"> <span
																		...
																		</span> <span class="comments-message">It's not clean
																				enough. It was amazingly cold</span>
																	</span>
																</span></td>
															</tr>
															<tr>
																<td class="name-cell"><span
																	class="comments-text-wrapper"> <span
																		...
																		</span> <span class="comments-message">Nice place and
																				a great value.</span>
																	</span>
																</span></td>
															</tr>
															<tr>
																<td class="name-cell"><span
																	class="comments-text-wrapper"> <span
																		...
																		</span> <span class="comments-message">What an amazing
																				spot for a romantic weekend getaway. We spent a lazy
																				weekend here doing nothing but enjoying the view and
																				the treehouse. 100% recommend.</span>
																	</span>
																</span></td>
															</tr>
															<tr>
																	...
																	class="comments-text-wrapper"> <span
																		...
																		class="comments-text"> <span
																			class="comments-name-wrapper"> <span
																				...
																				and quick walk to most things. We enjoyed the space.</span>
																	</span>
																</span></td>
															</tr>
														</tbody>
					...
					<div class="ba-dashboard-apps-dialog ba-dashboard-apps-list">
						<div class="ba-dashboard-apps-body">
							<div class="ba-gridbox-dashboard-row">
								<a
									href="https://www.balbooa.com/demo-admin/index.php?option=com_gridbox&amp;view=editor&amp;tmpl=component&amp;name=demo&amp;pwd=%242y%2410%24qAhmCj.D5ceMHhCL0kwq1.dXACYsK6SL%2FnmsaCtHVnhjZfNkqLBGa&amp;app_id=0&amp;id="
									target="_blank" class="gridbox-app-item-single"> <i
									class="zmdi zmdi-file"></i> <span>Pages</span>
								</a>
							</div>
							<div class="ba-gridbox-dashboard-row">
								<a
									href="https://www.balbooa.com/demo-admin/index.php?option=com_gridbox&amp;view=editor&amp;tmpl=component&amp;name=demo&amp;pwd=%242y%2410%24qAhmCj.D5ceMHhCL0kwq1.dXACYsK6SL%2FnmsaCtHVnhjZfNkqLBGa&amp;app_id=3&amp;id="
									target="_blank" class="gridbox-app-item-blog"> <i
									class="zmdi zmdi-format-color-text"></i> <span>Blog</span>
								</a>
							</div>
							<div class="ba-gridbox-dashboard-row">
								<a
									href="https://www.balbooa.com/demo-admin/index.php?option=com_gridbox&amp;view=editor&amp;tmpl=component&amp;name=demo&amp;pwd=%242y%2410%24qAhmCj.D5ceMHhCL0kwq1.dXACYsK6SL%2FnmsaCtHVnhjZfNkqLBGa&amp;app_id=14&amp;id="
									target="_blank" class="gridbox-app-item-blank"> <i
									class="zmdi zmdi-crop-free"></i> <span>Zero App</span>
								</a>
							</div>
							<div class="ba-gridbox-dashboard-row">
								<a
									href="https://www.balbooa.com/demo-admin/index.php?option=com_gridbox&amp;view=editor&amp;tmpl=component&amp;name=demo&amp;pwd=%242y%2410%24qAhmCj.D5ceMHhCL0kwq1.dXACYsK6SL%2FnmsaCtHVnhjZfNkqLBGa&amp;app_id=15&amp;id="
									target="_blank" class="gridbox-app-item-portfolio"> <i
									class="zmdi zmdi-camera"></i> <span>Portfolio</span>
								</a>
							</div>
							<div class="ba-gridbox-dashboard-row">
								<a
									href="https://www.balbooa.com/demo-admin/index.php?option=com_gridbox&amp;view=editor&amp;tmpl=component&amp;name=demo&amp;pwd=%242y%2410%24qAhmCj.D5ceMHhCL0kwq1.dXACYsK6SL%2FnmsaCtHVnhjZfNkqLBGa&amp;app_id=16&amp;id="
									target="_blank" class="gridbox-app-item-hotel-rooms"> <i
									class="zmdi zmdi-hotel"></i> <span>Hotel Rooms</span>
								</a>
							</div>
							<div class="ba-gridbox-dashboard-row">
								<a
									href="https://www.balbooa.com/demo-admin/index.php?option=com_gridbox&amp;view=editor&amp;tmpl=component&amp;name=demo&amp;pwd=%242y%2410%24qAhmCj.D5ceMHhCL0kwq1.dXACYsK6SL%2FnmsaCtHVnhjZfNkqLBGa&amp;app_id=17&amp;id="
									target="_blank" class="gridbox-app-item-products"> <i
									class="zmdi zmdi-shopping-basket"></i> <span>Products</span>
								</a>
							</div>
						</div>
					</div>
					<div class="ba-dashboard-apps-dialog ba-dashboard-about">
						<div class="ba-dashboard-apps-body">
							<div class="ba-gridbox-dashboard-row gridbox-version-wrapper">
								<i class="zmdi zmdi-info"></i> <span>Gridbox</span> <span
									class="gridbox-version">2.12.6</span>
							</div>
							<div
								class="ba-gridbox-dashboard-row gridbox-app-item-blog gridbox-deactivate-license">
								<i class="zmdi zmdi-shield-check"></i> <span>Your license
									is active</span> <a class="deactivate-link dashboard-link-action"
									href="#">Deactivate</a>
							</div>
							<div
								class="ba-gridbox-dashboard-row gridbox-app-item-blog gridbox-activate-license"
								style="display: none;">
								<i class="zmdi zmdi-shield-check"></i> <span>Activate
									license</span> <a class="activate-link dashboard-link-action" href="#">Activate</a>
							</div>
							<div
								class="ba-gridbox-dashboard-row gridbox-app-item-blog gridbox-update-wrapper">
								<i class="zmdi zmdi-check-circle"></i> <span>Gridbox is
									up to date</span>
							</div>
						</div>
						<div class="ba-dashboard-apps-footer">
							<span>© 2021 <a href="https://www.balbooa.com/"
								target="_blink">Balbooa.com</a> All Rights Reserved.
							</span>
						</div>
					</div>
					<div id="deactivate-dialog" class="ba-modal-sm modal hide"
						...
						<div class="modal-body">
							...
							<p class="modal-text can-delete">Are you sure you want to
								deactivate the license? The site will no longer receive updates.</p>
						</div>
						<div class="modal-footer">
							<a href="#" class="ba-btn" data-dismiss="modal"> Cancel </a> <a
					...
					<template class="ba-store-statistic-product-template">
						<div class="ba-store-statistic-product">
							...
							<div class="ba-store-statistic-product-content">
								<span class="ba-store-statistic-product-title-wrapper"> <span
									class="ba-store-statistic-product-title"></span> <span
					...
					<div class="ba-context-menu options-context-menu"
						...
						<span class="export-gridbox"> <i
						...
						</span> <span class="import-gridbox"> <i class="zmdi zmdi-upload"></i>
							<span class="ba-context-menu-title"> Import </span>
						</span> <span class="import-joomla-content"> <i
							class="zmdi zmdi-inbox"></i> <span class="ba-context-menu-title">
							...
							class="default-action"> <i class="zmdi zmdi-accounts"></i> <span
								class="ba-context-menu-title"> Permissions </span>
						</a>
						</span>
					</div>
					<div class="ba-context-menu store-context-menu"
						...
						<span class="context-menu-item-link"> <a
							...
							class="default-action"> <i class="zmdi zmdi-bookmark"></i> <span
								class="ba-context-menu-title"> Discounts </span>
						</a>
						</span> <span class="context-menu-item-link"> <a
							...
							class="default-action"> <i class="zmdi zmdi-settings"></i> <span
								class="ba-context-menu-title"> Settings </span>
						</a>
						</span>
					</div>
							...
							<div class="languages-wrapper">
								...
								<div class="language-line">
									<span class="language-img"><img
										...
										class="language-title" data-key="1">Chinese Simplified</span><span
										class="language-code">zh-CN</span>
								</div>
								<div class="language-line">
									<span class="language-img"><img
					...
					<div id="import-dialog" class="ba-modal-sm modal hide"
						...
						<div class="modal-header">
							...
							<label class="ba-help-icon"> <i class="zmdi zmdi-help"></i>
								<span class="ba-tooltip ba-help ba-hide-element"> Import
									a previously exported Gridbox Pages and Themes. Select .xml
									file to import. </span>
							</label>
						</div>
						<div class="modal-body">
						...
						<div class="modal-body">
							<div class="general-tabs">
								<ul class="nav nav-tabs uploader-nav">
									...
									<li><a href="#crop-image-options" data-toggle="tab"> <i
											class="zmdi zmdi-crop"></i> <span
									...
									<li><a href="#flip-rotate-image-options" data-toggle="tab">
											<i class="zmdi zmdi-flip"></i> <span
								...
								<div class="resize-image-wrapper">
									...
									<div class="ba-crop-overlay" style="opacity: 0;">
										...
										<span class="ba-crop-overlay-resize-handle"
											...
											class="ba-crop-overlay-resize-handle" data-resize="top-right"></span>
										<span class="ba-crop-overlay-resize-handle"
								...
								<div class="tab-content">
									...
									<div id="crop-image-options" class="row-fluid tab-pane">
										<div class="ba-settings-group">
											<div class="ba-settings-toolbar">
												<div>
													<span>Width</span> <input type="number" class="crop-width"
											...
											<div class="ba-settings-item">
												<span>Keep Proportions</span> <label class="ba-checkbox">
													<input type="checkbox" class="keep-proportions"> <span></span>
												</label>
											</div>
											<div class="ba-settings-item">
									...
									<div id="flip-rotate-image-options" class="row-fluid tab-pane">
										<span> <i class="zmdi zmdi-rotate-left rotate-action"
											data-rotate="-90"></i> <span class="ba-tooltip ba-bottom">Rotate
												Left</span>
										</span> <span> <i class="zmdi zmdi-rotate-right rotate-action"
											data-rotate="90"></i> <span class="ba-tooltip ba-bottom">Rotate
												Right</span>
											...
											data-flip="vertical"></i> <span class="ba-tooltip ba-bottom">Flip
												Vertical</span>
										</span>
										<div class="photo-editor-footer">
											<a href="#" class="reset-image">Reset</a> <a href="#"
					...
					<div id="save-copy-notice-dialog" class="ba-modal-sm modal hide">
						<div class="modal-body">
							<h3 class="ba-modal-title">Save as Copy</h3>
							<p class="modal-text">The file already exists. Do you want to
								overwrite it?</p>
						</div>
						<div class="modal-footer">
							<a href="#" class="ba-btn" data-dismiss="modal"> Cancel </a> <a
					...
					<div class="ba-context-menu save-image-context-menu"
						style="display: none;">
						<span class="photo-editor-save-copy"> <span>Save as
								Copy</span>
