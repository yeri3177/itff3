...
<div class="login_con">
	<form:form action="${pageContext.request.contextPath}/member/memberFindById.do">
			<div class="login_form_wrap">   
					<div class="form_group wid100 on">
						<div class="d_tbl">
							<span class="form_txt">
								<input type="text" name="name" id="name" style="-webkit-ime-mode:inactive;ime-mode:inactive;text-transform:lowercase;" placeholder="가입시 입력한 이름을 입력해주세요" title="이름" value="" required>
							</span>
						</div>
					</div>
					...
					<div class="form_group wid100 ">  
						<div class="d_tbl">
							<span class="form_txt input_mouse">
								<input type="text" name="email" id="email" placeholder="가입시 입력한 이메일 입력해주세요" title="휴대폰번호" required enc="on" data-keypad-type="alpha" class="nppfs-npk nppfs-dynamic-field nppfs-npv" autocorrect="off" spellcheck="false" autocomplete="off" autocapitalize="off" data-keypad-next="__hide__" data-keypad-useyn-type="toggle" data-keypad-useyn-input="__KU_db4c02124ff6" nppfs-keypad-uuid="nppfs-keypad-loginPwd" style="color: rgb(0, 0, 0);" data-input-useyn-type="toggle" value="">
							</span>
						</div>
					</div>  
