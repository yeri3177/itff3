...
<div class="d3tab_basic">
	<ul id="depth3" class="depth3_ul">
		...
		<li class="depth3_li on_1_7"><a
			href="${pageContext.request.contextPath }/schedule/day8.do" target="_top" style="color: white; background-color: #212121; border-color: #212121;">1월 14일</a></li>
	</ul>
</div>
			...
			<div class="schedule_tab_sec" style="">
				<div class="container">
					<ul class="sch_2depth list-inline">
						...
						<li class="on"><a href="date.asp?day1=15" target="_self"><span
					...
					<div class="tbl_schedule_wrap">
						...
						<div class="tbl_schedule tbl_schedule_date">
							...
							<div class="sch_li">
								...
								<div class="sch_it sch_it8 blank_wrap">
								<span class="sch_it_blank"></span>
								</div>
								
								<div class="sch_it sch_it9 blank_wrap">
								<span class="sch_it_blank"></span>
								</div>
								...
								<div class="sch_it sch_it14 blank_wrap">
								<span class="sch_it_blank"></span>
								</div>

								<div class="sch_it sch_it15 blank_wrap">
								<span class="sch_it_blank"></span>
								</div>
