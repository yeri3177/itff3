...
<div class="d3tab_basic">
	<ul id="depth3" class="depth3_ul">
		...
		<li class="depth3_li on_1_1"><a
			href="${pageContext.request.contextPath }/schedule/day2.do" target="_top" style="color: white; background-color: #212121; border-color: #212121;">1월 8일</a></li>
			...
			<div class="schedule_tab_sec" style="">
				<div class="container">
					<ul class="sch_2depth list-inline">
						...
						<li class="on"><a href="date.asp?day1=7" target="_self"><span
						...
						<div class="tbl_schedule tbl_schedule_date">
							...
							<div class="sch_li">
								...
								<span class="code en">011</span>
									...
									<div class="film_tit">
										<a
											href="${pageContext.request.contextPath }/movie/booking.do?playdate=2022-01-08&movieId=movie-011"><span
								...
								<div class="sch_it sch_it2">
									...
									<div class="film_tit">
										<a
											href="${pageContext.request.contextPath }/movie/booking.do?playdate=2022-01-08&movieId=movie-001"><span
								...
								<div class="sch_it sch_it3">
									...
									<div class="film_tit">
										<a
											href="${pageContext.request.contextPath }/movie/booking.do?playdate=2022-01-08&movieId=movie-010"><span
								...
								<div class="sch_it sch_it4">
									...
									<div class="film_tit">
										<a
											href="${pageContext.request.contextPath }/movie/booking.do?playdate=2022-01-08&movieId=movie-005"><span
								...
								<div class="sch_it sch_it5">
									...
									<div class="film_tit">
										<a
											href="${pageContext.request.contextPath }/movie/booking.do?playdate=2022-01-08&movieId=movie-008"><span
								...
								<div class="sch_it sch_it6">
									...
									<div class="film_tit">
										<a
											href="${pageContext.request.contextPath }/movie/booking.do?playdate=2022-01-08&movieId=movie-003"><span
								...
								<div class="sch_it sch_it10">
									...
									<div class="film_tit">
										<a
											href=" ${pageContext.request.contextPath }/movie/booking.do?playdate=2022-01-08&movieId=movie-012"><span
								...
								<div class="sch_it sch_it14">
									...
									<div class="film_tit">
										<a
											href="${pageContext.request.contextPath }/movie/booking.do?playdate=2022-01-08&movieId=movie-006"><span
								...
								<div class="sch_it sch_it15">
									...
									<div class="film_tit">
										<a
											href="${pageContext.request.contextPath }/movie/booking.do?playdate=2022-01-08&movieId=movie-004"><span
