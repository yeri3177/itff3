...
<div class="d3tab_basic">
	<ul id="depth3" class="depth3_ul">
		...
		<li class="depth3_li on_1_6"><a
			href="${pageContext.request.contextPath }/schedule/day7.do" target="_top" style="color: white; background-color: #212121; border-color: #212121;">1월 13일</a></li>
			...
			<div class="schedule_tab_sec" style="">
				<div class="container">
					<ul class="sch_2depth list-inline">
						...
						<li class="on"><a href="date.asp?day1=14" target="_self"><span
